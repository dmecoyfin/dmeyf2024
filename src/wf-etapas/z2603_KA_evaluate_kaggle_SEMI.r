#!/usr/bin/env Rscript
cat( "ETAPA  z2603_KA_evaluate_kaggle_semillerio.r  INIT\n")
...
cat( "ETAPA  z2603_KA_evaluate_kaggle_semillerio.r  START\n")
action_inicializar() 
...
cat( "ETAPA  z2603_KA_evaluate_kaggle_semillerio.r  END\n")
